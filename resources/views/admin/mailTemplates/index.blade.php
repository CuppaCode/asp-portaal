...
@section('content')
@can('mail_template_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.mail-templates.create') }}">
                {{ trans('global.add') }} {{ trans('cruds.mailTemplate.title_singular') }}
            </a>
        </div>
    </div>
@endcan
<div class="card">
    <div class="card-header">
        {{ trans('cruds.mailTemplate.title_singular') }} {{ trans('global.list') }}
    </div>

    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-MailTemplate">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.mailTemplate.fields.name') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($mailTemplates as $key => $mailTemplate)
                        <tr data-entry-id="{{ $mailTemplate->id }}">
                            <td>
                            ...
                            <td>
                                ...
                                @can('mail_template_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.mail-templates.edit', $mailTemplate->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan
