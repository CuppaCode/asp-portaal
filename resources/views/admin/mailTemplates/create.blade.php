        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('trigger_type') ? 'is-invalid' : '' }}" name="trigger_type" id="trigger_type">
                    ...
                    <option value="CERTIFICATE_EXPIRING" {{ old('trigger_type') == 'CERTIFICATE_EXPIRING' ? 'selected' : '' }}>{{ trans('cruds.superAdmin.triggers.types.CERTIFICATE_EXPIRING.name') }}</option>
                    <option value="CERTIFICATE_RENEWED" {{ old('trigger_type') == 'CERTIFICATE_RENEWED' ? 'selected' : '' }}>{{ trans('cruds.superAdmin.triggers.types.CERTIFICATE_RENEWED.name') }}</option>
                    <option value="CERTIFICATE_NOTIFICATION_ERROR" {{ old('trigger_type') == 'CERTIFICATE_NOTIFICATION_ERROR' ? 'selected' : '' }}>{{ trans('cruds.superAdmin.triggers.types.CERTIFICATE_NOTIFICATION_ERROR.name') }}</option>
