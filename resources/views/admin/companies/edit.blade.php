                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control {{ $errors->has('contact_id') ? 'is-invalid' : '' }}" name="contact_id" id="contact_id">
                            <option value disabled {{ old('contact_id', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                            @foreach($contacts as $id => $entry)
                                <option value="{{ $entry->id }}" {{ (old('contact_id') ? old('contact_id') : $company->contact_id ?? '' ) == $entry->id ? 'selected' : '' }}>{{ $entry->first_name ." ". $entry->last_name }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        @if($company->logo)
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $company->logo) }}" alt="Company Logo" style="max-height: 80px; border: 1px solid #ddd; padding: 5px; border-radius: 4px;">
                            </div>
                        @endif
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('bank_account_number') ? 'is-invalid' : '' }}" type="text" name="bank_account_number" id="bank_account_number" value="{{ old('bank_account_number', $company->bank_account_number) }}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('company_size') ? 'is-invalid' : '' }}" type="text" name="company_size" id="company_size" value="{{ old('company_size', $company->company_size) }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('truck_count') ? 'is-invalid' : '' }}" type="number" name="truck_count" id="truck_count" value="{{ old('truck_count', $company->truck_count) }}">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <textarea class="form-control {{ $errors->has('additional_information') ? 'is-invalid' : '' }}" name="additional_information" id="additional_information">{{ old('additional_information', $company->additional_information) }}</textarea>
