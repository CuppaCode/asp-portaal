...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#vehicle_opposite_drivers" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="vehicle_opposite_drivers">
            @includeIf('admin.vehicleOpposites.relationships.vehicleOppositeDrivers', ['drivers' => $vehicleOpposite->vehicleOppositeDrivers])
        </div>
