    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('opposite_claim_no') ? 'is-invalid' : '' }}" type="number" name="opposite_claim_no" id="opposite_claim_no" value="{{ old('opposite_claim_no', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('driver_vehicle') ? 'is-invalid' : '' }}" name="driver_vehicle" id="driver_vehicle">
                    @foreach($drivers as $id => $entry)
                        <option value="{{ $id }}" {{ old('driver_vehicle') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group expertise-report-show d-none">
                ...
                <input class="form-control date {{ $errors->has('report_received_at') ? 'is-invalid' : '' }}" type="text" name="report_received_at" id="report_received_at" value="{{ old('report_received_at') }}">
        ...
        <div class="card-body">
            <div class="form-row">
                ...
                <div class="form-group col-md-3">
                    ...
                    <input class="form-control {{ $errors->has('invoice_settlement_asp') ? 'is-invalid' : '' }}" type="checkbox" name="invoice_settlement_asp" id="invoice_settlement_asp" value="1">
                </div>
