...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-claimNotes">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($notes as $key => $note)
                        <tr data-entry-id="{{ $note->id }}">
                            ...
                            <td>
                                @foreach($note->claims as $key => $item)
                                    <span class="badge badge-info">{{ $item->claim_number }}</span>
                                @endforeach
                            </td>
                            <td>
                                {{ $note->user->email ?? '' }}
...
@endcan
  ...
  let table = $('.datatable-claimNotes:not(.ajaxTable)').DataTable({ buttons: dtButtons })
