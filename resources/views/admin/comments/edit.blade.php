    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.comments.update", [$comment->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('commentable') ? 'is-invalid' : '' }}" type="number" name="commentable" id="commentable" value="{{ old('commentable', $comment->commentable) }}" step="1" required>
